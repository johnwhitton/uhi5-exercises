...
[rpc_endpoints]
sepolia = "${RPC_SEPOLIA_URL}"
op_sepolia = "${RPC_OP_SEPOLIA_URL}"
```

Also, you'll need to create a `.env` file using your alchemy keys

```
RPC_SEPOLIA_URL=https://eth-sepolia.g.alchemy.com/v2/<<Alchemy_API_Key>>
RPC_OP_SEPOLIA_URL=https://opt-sepolia.g.alchemy.com/v2/<<Alchemy_API_Key>>
ETHERSCAN_API_KEY=<<Etherscan_API_Key>>
PRIVATE_KEY=<<Your_Private_Key>>
```

I had issues using a public RPC URL for ETH Sepolia and OP Sepolia for testing purposes - so moved to Alchemy.
